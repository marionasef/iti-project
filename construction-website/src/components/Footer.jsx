...
export default function Footer() {
  return (
    ...
    <div className='footer container-fluid d-flex '>
      <div className='left-footer w-50 d-flex flex-lg-column  flex-sm-column  align-items-start   justify-content-center'>
      ...
      <Row className=' row-adjust w-75 gap-3 d-flex justify-content-center ps-5 pt-5 '  >
      ...
      <p className=' text-light  ps-5  pt-5'>Merkulove © Dustro Template All rights reserved Copyrights 2020</p>
    </Container></div>
    </div>
    </>
  )
