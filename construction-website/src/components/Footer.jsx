    ...
    <div className='footer container-fluid d-flex '>
      <div className='left-footer d-flex flex-lg-column  flex-sm-column  flex-md-column align-items-start   justify-content-center'>
        ...
        {/* links start */}
                  ...
                  <p className='info-text w-50'>Lorem ipsum dolor sit amet consectetur</p>
      </div>
      <div className='right-footer w-75 '> <Container fluid="md">
      <Row className=' row-adjust w-100 gap-2 d-flex justify-content-center ps-5 pt-5 '  >
      <Col className=' text-light lh-lg'> <h3 className=' fs-4 fw-normal'>Quick Links</h3>
                                          About Company
                                          Our Services
                                          Our Projects
                                          Pricings
                                          Contacts</Col>
        <Col className='  text-light lh-lg' > <h3 className=' fs-4  fw-normal'>Clients Support</h3>
                                            Careers
                                            Our Process
                                            FAQs
                                            Clients Testimonials
                                            Our Blog</Col> 
         <Col className=' text-light lh-lg'> <h3 className=' fs-4  fw-normal'>Our News</h3>
                                            Agile Construction 
                                            Management Building
                                            Top Saas Construction </Col>
      </Row>
      <p className=' last-text text-light  ps-5  pt-5'>Merkulove © Dustro Template All rights reserved Copyrights 2020</p>
    </Container></div>
    </div>
    </>
  )
